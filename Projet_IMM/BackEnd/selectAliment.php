<?php
            ...
            try{
                ...
                $infosAliments = $dbco->prepare("SELECT libelle_aliment, En.Ratio AS Energie, Pro.Ratio AS Protéines, Glu.Ratio As Glucides, Lip.Ratio As Lipides, Suc.Ratio As Sucres, Alc.Ratio As Alcool, Sod.Ratio As Sodium, Eau.Ratio As Eau FROM `aliment` 
